...
| `crate.nodeSelector`              | Crate Node labels for pod assignment        | {}                                                  |
| `crate.tolerations`               | Toleration labels for Crate pod assignment  | []                                                  |
| `crate.affinity`                  | Affinity settings for Crate pod assignment  | {}                                                  |
